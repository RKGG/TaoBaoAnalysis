...
When use Selenium open Taobao login page, the server of taobao will recognize me as a robot even ifI just use Selenium Webdriver to open the login website(www.login.taobao.com) and type the username and password by my hand and slide the slide bar by hand. Which means the moment I open the website via Python Selenium program, the taobao server recognizes me as a spider and want to block me no matter latter operations are done by true human or robot. It actually didn't detect whether I am a robot or human by slide bar or other.
More infomation at : https://stackoverflow.com/questions/33225947/can-a-website-detect-when-you-are-using-selenium-with-chromedriver  However, changing the webdriver code didn't work for me. Therefore the only way to achieve this project is to use taobao official API.
